    ...
    <header class="bg-white p-4">
        <nav class="flex justify-between items-center w-full mx-auto">
            <div class="flex items-center">
                <img class="w-16 items-start cursor-pointer" src="./Image/Technology.png" alt="webcraft studio">
                <a href="">
                    <b>WebCraft Studio</b>
                </a>
            </div>
            <div
                class="ml-4 lg:ml-0 z-40 nav-links duration-500 md:static absolute bg-white md:min-h-fit min-h-[30vh] left-0 top-[-100%] md:w-auto  w-full flex items-center px-5">
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8">
                    <li>
                        <a class="hover:text-gray-500" href="#">Beranda</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="#3">Produk</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="#2">Testimoni</a>
                    </li>
                </ul>
            </div>
