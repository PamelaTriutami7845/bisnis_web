...
<head>
    ...
    <title>Paket coding</title>
</head>
<body>
<div id="1" class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16" id="1">
    <h2 class="text-2xl font-bold mb-2 text-center">Paket Coding</h2>
<div class="border-b mb-5 flex justify-between text-sm">
    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
        ...
        <a href="#" class="font-semibold inline-block">Pengembangan Aplikasi</a>
    </div>
    <!-- <a href="#">See All</a> -->
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
    ...
    <div class="relative rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
            ...
            ✔ 1 Website <br>
            ✔ 4 x Revisi <br>
            ✔ Fitur sesuai keinginan dari customer <br>
            ✔ Harga menyesuaikan jenis dan fitur dari website <br>
            ✔ Deadline menyesuaikan dari tingkat kesulitan <br>
            <p class="mt-3 mb-6 font-bold text-black text-sm">Harga Mulai dari: Rp.3.000.000</p>
            </p>
<br>
            <div class="absolute bottom-0 right-0 left-0 mt-auto mb-3 px-4"> <!-- Added padding on the sides -->
            <button class="w-full px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75" onclick="addToCart(27, 'Paket Coding-Website', 3000000)">
                Add to Cart
            </button>
</div>
        </div>
    ...
    <div class="relative rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
            <a href="#"
                class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">Mobile Android</a>
            ...
            ✔ Harga menyesuaikan jenis dan fitur dari website <br>
            ✔ Deadline menyesuaikan dari tingkat kesulitan <br>
            <p class="mt-3 mb-6 font-bold text-black text-sm">Harga Mulai dari: Rp.12.000.000</p>
            </p>
     <br>
            <div class="absolute bottom-0 right-0 left-0 mt-auto mb-3 px-4"> <!-- Added padding on the sides -->
            <button class="w-full px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75" onclick="addToCart(28, 'Paket Coding-Mobile Android', 12000000)">
                Add to Cart
            </button>
</div>
        </div>
    ...
    <div class="relative rounded overflow-hidden shadow-lg flex flex-col">
        ...
        <div class="px-6 py-4 mb-auto">
            ...
            ✔ Harga menyesuaikan jenis dan fitur dari website <br>
            ✔ Deadline menyesuaikan dari tingkat kesulitan <br>
            <p class="mb-6 mt-3 font-bold text-black text-sm">Harga: Rp.17.000.000</p>
            </p>
       <br>
            <div class="absolute bottom-0 right-0 left-0 mt-auto mb-3 px-4"> <!-- Added padding on the sides -->
            <button class="w-full px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75" >
                Add to Cart
            </button>
</div>
        </div>
